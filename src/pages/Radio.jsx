          ...
          <div className="flex justify-between flex-wrap">
            {radios.map((radio, index) => (
              <button
                ...
                data-url={radio.url}
                onClick={handleClick}
                className="px-4 opacity-0 scale-50 duration-300 py-2 mb-2 w-full flex md:w-[48%] lg:w-[32%] bg-backgroundItem bg-fixed bg-cover bg-gray-100 dark:bg-neutral-900 hover:bg-gray-200 dark:hover:bg-gray-700 rounded">
